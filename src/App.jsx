...
export default function App() {
    ...
    useEffect(() => {
        // RESET state
        setDisplayDivTwo("none");
        setDisplayDivThree("none");
        setDisplayDivFour("none");
        setDisplayDivFive("none");
        setActiveId("");
            ...
            <Route path="/Web-Porto/" element={
                <div className="wrapper overflow hide-scrollbar">
                    <div className="content-pane" style={{display:"flex", flexDirection:"column"}}>
                        ...
                        <div className="container-content-porto hide-scrollbar" style={{display:"flex", flexDirection:"column"}}>
                            <Contacts/>
                            <Navbar
                                activeId={activeId}
                            />
