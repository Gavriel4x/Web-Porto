    ...
    return (
        <div className="wrapper-nav" style={{display:"flex", cursor:"default"}}>
            <div className="container-about" style={{display:"flex", flexDirection:"row", alignItems:"center", gap:"12px"}}>
                ...
                <div id="line-about" className={`svg-line-nav default-background-color ${props.activeId === "about" ? "active-background-color" : ""}`} style={{ height:"1px"}} ></div>
            </div>
            <div className="container-experience" style={{display:"flex", flexDirection:"row", alignItems:"center", gap:"12px"}}>
                ...
                <div id="line-experience" className={`svg-line-nav default-background-color ${props.activeId === "experience" ? "active-background-color" : ""}`} style={{ height:"1px"}} ></div>
            </div>
            <div className="container-projects" style={{display:"flex", flexDirection:"row", alignItems:"center", gap:"12px"}}>
                ...
                <div id="line-projects" className={`svg-line-nav default-background-color ${props.activeId === "projects" ? "active-background-color" : ""}`} style={{ height:"1px"}} ></div>
            </div>
            <div className="container-certifications" style={{display:"flex", flexDirection:"row", alignItems:"center", gap:"12px"}}>
                ...
                <div id="line-certifications" className={`svg-line-nav default-background-color ${props.activeId === "certifications" ? "active-background-color" : ""}`} style={{ height:"1px"}} ></div>
            </div>
        </div>
    );
};